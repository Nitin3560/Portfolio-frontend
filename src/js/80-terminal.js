  ...
  var FILES = {
    ...
    "experience.txt": [
      ...
      "",
      "Interview Bot | Software Development Engineer Intern · Seattle, WA     Sep 2023 – Dec 2023",
      "  · Migrated backend services and PostgreSQL from AWS EC2 to GKE, cutting deployment time by 60%.",
      "  · Built GitHub Actions CI/CD across 3 microservices.",
      "  · Configured Kubernetes deployments, HPA, load balancing, IAM, VPC, and Helm charts.",
      "",
